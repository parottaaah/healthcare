      ...
      <main className="main-content">
        ...
        <section className="upload-section card">
          ...
          <p className="section-desc">
            Supports PDF, JPEG, and PNG (max 10 MB). Line items are extracted automatically via OCR.
          </p>
        ...
        <section className="bills-section">
          {loading ? (
            <div className="loading-state">
              <div className="spinner" aria-label="Loading bills" />
            ...
            <div className="bills-grid">
              {bills.map((bill) => (
                <Link to={`/bills/${bill.id}`} key={bill.id} className="bill-card card">
